...
import com.liferay.trainning.todo.model.TodoModel;
...
public class TodoModelImpl extends BaseModelImpl<Todo> implements TodoModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"todoId", Types.BIGINT},
		{"groupId", Types.BIGINT}, {"companyId", Types.BIGINT},
		{"userId", Types.BIGINT}, {"userName", Types.VARCHAR},
		{"createDate", Types.TIMESTAMP}, {"modifiedDate", Types.TIMESTAMP},
		{"title", Types.VARCHAR}, {"isComplete", Types.BOOLEAN}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("isComplete", Types.BOOLEAN);
	}

	public static final String TABLE_SQL_CREATE =
		"create table TODO_Todo (uuid_ VARCHAR(75) null,todoId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,isComplete BOOLEAN)";

	public static final String TABLE_SQL_DROP = "drop table TODO_Todo";

	public static final String ORDER_BY_JPQL = " ORDER BY todo.title ASC";

	public static final String ORDER_BY_SQL = " ORDER BY TODO_Todo.title ASC";
	...
	static {
		...
		attributeGetterFunctions.put("isComplete", Todo::getIsComplete);
		attributeSetterBiConsumers.put(
			"isComplete", (BiConsumer<Todo, Boolean>)Todo::setIsComplete);
	...
	public Object clone() {
		...
		todoImpl.setIsComplete(isIsComplete());
	...
	public Todo cloneWithOriginalValues() {
		...
		todoImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		todoImpl.setTodoId(this.<Long>getColumnOriginalValue("todoId"));
		todoImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		todoImpl.setCompanyId(this.<Long>getColumnOriginalValue("companyId"));
		todoImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		todoImpl.setUserName(this.<String>getColumnOriginalValue("userName"));
		todoImpl.setCreateDate(this.<Date>getColumnOriginalValue("createDate"));
		todoImpl.setModifiedDate(
			this.<Date>getColumnOriginalValue("modifiedDate"));
		todoImpl.setTitle(this.<String>getColumnOriginalValue("title"));
		todoImpl.setIsComplete(
			this.<Boolean>getColumnOriginalValue("isComplete"));
	...
	public int compareTo(Todo todo) {
		...
		value = getTitle().compareTo(todo.getTitle());
	...
	public CacheModel<Todo> toCacheModel() {
		...
		todoCacheModel.isComplete = isIsComplete();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("isComplete", _isComplete);
	}
	...
	static {
		...
		columnBitmasks.put("isComplete", 512L);
