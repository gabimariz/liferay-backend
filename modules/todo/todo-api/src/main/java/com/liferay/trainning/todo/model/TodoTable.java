...
public class TodoTable extends BaseTable<TodoTable> {
	...
	public final Column<TodoTable, String> title = createColumn(
		"title", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<TodoTable, Boolean> isComplete = createColumn(
		"isComplete", Boolean.class, Types.BOOLEAN, Column.FLAG_DEFAULT);
